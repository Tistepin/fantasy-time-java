...
create table fantasytime.ft_cartoon_works_details
(
    id                   bigint auto_increment comment 'id'
        primary key,
...
create table fantasytime.ft_novel_works_details
(
    id                 bigint auto_increment comment 'id'
        primary key,
    works_id           char(20)                           null comment '作品id',
...
create table fantasytime.ft_popularity
(
    id                          bigint auto_increment comment 'id'
        primary key,
    works_id                    char(20)                           null comment '作品id',
...
create table fantasytime.ft_role_user
(
...
create table fantasytime.ft_roles
(
    id            bigint auto_increment comment 'id'
        primary key,
